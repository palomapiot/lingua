        ...
        <div class="col-md-12" style="margin-top: 1em;">
            <div v-for="k in dataset.header">
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        <h6 class="card-subtitle text-muted">{{ getLabelById(dataset.content[currentRow], k) }}</h6>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="bs-component mb-6" v-if="Array.isArray(Object.values(k)[0])">
                        <div class="btn-group" role="group" id="annotationLabel" aria-label="">
                            <div v-for="ah_value in Object.values(k)[0]">
                            <input 
                                type="radio"
                                class="btn-check"
            ...
            <nav aria-label="Dataset navigation">
                <ul class="pagination justify-content-center">
                    ...
                    <li class="page-item" :class="{ 'disabled' : currentRow === totalRows }">
